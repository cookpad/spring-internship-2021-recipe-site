...
export const CLIENT_API_SERVER_ROOT = getCurrentFullUrl("/api");
export const CLIENT_API_ENDPOINT_RECIPES = `${CLIENT_API_SERVER_ROOT}/recipes`;
export const CLIENT_API_ENDPOINT_SEARCH = `${CLIENT_API_SERVER_ROOT}/search`;
export const CLIENT_API_ENDPOINT_IMAGE_URLS = `${CLIENT_API_SERVER_ROOT}/image_urls`;
